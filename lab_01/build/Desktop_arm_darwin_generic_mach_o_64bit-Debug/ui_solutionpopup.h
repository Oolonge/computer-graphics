/********************************************************************************
** Form generated from reading UI file 'solutionpopup.ui'
**
...
#ifndef UI_SOLUTIONPOPUP_H
#define UI_SOLUTIONPOPUP_H
...
public:
    ...
    void setupUi(QDialog *solutionpopup)
    {
        if (solutionpopup->objectName().isEmpty())
            solutionpopup->setObjectName("solutionpopup");
        solutionpopup->resize(819, 655);
        gridLayoutWidget = new QWidget(solutionpopup);
        ...
        retranslateUi(solutionpopup);

        QMetaObject::connectSlotsByName(solutionpopup);
    } // setupUi

    void retranslateUi(QDialog *solutionpopup)
    {
        solutionpopup->setWindowTitle(QCoreApplication::translate("solutionpopup", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("solutionpopup", "\320\234\320\260\321\201\321\210\321\202\320\260\320\261:", nullptr));
        label_2->setText(QCoreApplication::translate("solutionpopup", "%", nullptr));
        showCoordinatesRadio->setText(QCoreApplication::translate("solutionpopup", "\320\232\320\276\320\276\321\200\320\264\320\270\320\275\320\260\321\202\321\213", nullptr));
    } // retranslateUi

};

namespace Ui {
    class solutionpopup: public Ui_solutionpopup {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SOLUTIONPOPUP_H
