    ...
    , ui(new Ui::TaskPopup)
{
    ...
    ui->label->setText("На плоскости дано множество точек.\n\nНайти такой треугольник с вершинами\nв этих точках, у которого максимальная\nпо длинне биссектриса минимальна\n\nВывести картинку в графическом виде.");
}
...
void TaskPopup::onCloseButtonClicked()
{
    this->close();
}
