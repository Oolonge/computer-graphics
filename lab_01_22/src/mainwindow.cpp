...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(ui->showSolutionButton, SIGNAL(clicked(bool)), this,
          SLOT(showSolution()));
...
void MainWindow::showTask() { taskptr->show(); }

void MainWindow::showSolution() { solutionptr->show(); }

void MainWindow::showAbout() { aboutptr->show(); }
