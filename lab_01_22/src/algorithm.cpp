...
void GraphicScene::calculateVectors(const QVector<QPointF> &triangle,
                                    QVector2D &vecA, QVector2D &vecB,
                                    QVector2D &vecC, qreal &a, qreal &b,
                                    qreal &c) {
...
void GraphicScene::compareMins(const QVector<QPointF> &triangle,
                               const QVector2D &vecAK, const QVector2D &vecBK,
                               const QVector2D &vecCK, qreal &bMin, qreal &bMax,
