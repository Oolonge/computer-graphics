...
Test::Test(QString name, QString desc, QColor fill_color, QList<point> point_vector, point seed_point, bool is_full) : \
    name_(name), desc_(desc), fill_color_(fill_color), point_vector_(point_vector), seed_point_(seed_point), full_test_(is_full) {}
...
point Test::seed_point() const { return this->seed_point_; }
